...
data class BackGround(val name:String,
                      val description:String)
data class Hero(
    val name:String?, //имя игрового персонажа
    val race: Int?, // расса персонажа
    val level: String?, // уровень
    val background: Int?, // предистория
    val alignment: Int?, //мировоззрение
